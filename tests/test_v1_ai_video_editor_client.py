...
def test_create_200_success_all_params() -> None:
    """Tests a POST request to the /v1/ai-video-editor endpoint.
    ...
    Response : models.V1AiVideoEditorCreateResponse
    ...
    response = client.v1.ai_video_editor.create(
    ...
    try:
        pydantic.TypeAdapter(models.V1AiVideoEditorCreateResponse).validate_python(
            response
        )
...
async def test_await_create_200_success_all_params() -> None:
    ...
    response = await client.v1.ai_video_editor.create(
        assets={"video_file_path": "api-assets/id/1234.mp4"},
        end_seconds=5.0,
        style={"prompt": "Change the car color to blue"},
        model="gemini-omni-1.1",
