...
| `└─ prompt_type`      |    ✓     | _ `custom` - Use your own prompt for the video. _ `use_lyrics` - Use the lyrics of the audio to create the prompt. If this option is selected, then `assets.audio_source` must be `file` or `youtube`. \* `ai_choose` - Let AI write the prompt. If this option is selected, then `assets.audio_source` must be `file` or `youtube`.                                                                           | `"custom"`                                                                                                                                               |
| `└─ transition_speed` |    ✓     | Change determines how quickly the video's content changes across frames. _ Higher = more rapid transitions. _ Lower = more stable visual experience.                                                                                                                                                                                                                                                           | `5`                                                                                                                                                      |
