...
| `fps_resolution`     |    ✗     |     ✗      | Determines whether the resulting video will have the same frame per second as the original video, or half. _ `FULL` - the result video will have the same FPS as the input video _ `HALF` - the result video will have half the FPS as the input video                                                                                                                                                       | `"HALF"`                                                                                         |
