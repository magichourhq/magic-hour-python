...
class V1TextToVideoCreateBody(typing_extensions.TypedDict):
    ...
    * `wan-3.0`: High-quality video with native audio, long clips, and end-frame control.
    ...
    references: typing_extensions.NotRequired[
        typing.List[V1TextToVideoCreateBodyReferencesItem]
    ]
...
class _SerializerV1TextToVideoCreateBody(pydantic.BaseModel):
    ...
    references: typing.Optional[
        typing.List[_SerializerV1TextToVideoCreateBodyReferencesItem]
    ] = pydantic.Field(alias="references", default=None)
